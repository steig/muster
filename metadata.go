...
func encodeReport(r report) (map[string]any, error) {
...
func decodeReport(tokens map[string]string) (report, bool) {
...
// writeReport delivers the tokens and reads them back.
//
